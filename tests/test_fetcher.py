...
class TestYamlFetcher:
    ...
    def test_fetch_canasta_revisions_with_version(self, mock_load, fetcher):
        ...
        mock_load.assert_called_once_with(repo="CanastaWiki/RecommendedRevisions", ref="main", file_path="1.44.yaml")
    ...
    def test_fetch_canasta_revisions_without_version(self, mock_load, fetcher):
        ...
        mock_load.assert_called_once_with(repo="CanastaWiki/RecommendedRevisions", ref="main", file_path="1.43.yaml")
        assert result == {"extensions": []}
    ...
    def test_fetch_taqasta_values(self, mock_load, fetcher):
        ...
        mock_load.assert_called_once_with(repo="WikiTeq/Taqasta", ref="master", file_path="values.yml")
        assert result == {"extensions": []}
